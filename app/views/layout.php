...
<link rel="icon" type="image/svg+xml" href="<?= e(CONFIG['base_path']) ?>/assets/img/logo.svg">
...
<link href="<?= e(CONFIG['base_path']) ?>/assets/css/style.css?v=31" rel="stylesheet">
</head>
<body>
...
<script src="<?= e(CONFIG['base_path']) ?>/assets/js/helppy.js?v=11"></script>
</body>
</html>
